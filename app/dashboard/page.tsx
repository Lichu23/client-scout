...
export default async function Dashboard() {
  ...
  return <div className="mx-auto max-w-7xl">
    ...
    <section className="mt-10"><div className="flex flex-wrap items-center justify-between gap-3"><div><h2 className="text-xl font-bold tracking-tight">Recent searches</h2><p className="mt-1 text-sm text-slate-500">Each card represents one gathering run and its businesses.</p></div><Link href="/searches" className="text-sm font-semibold text-blue-600 hover:text-blue-700 hover:underline">View search history →</Link></div>
